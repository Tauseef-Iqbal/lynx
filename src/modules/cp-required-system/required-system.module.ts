...
import { RequiredSystemBusinessClassificationEntity, RequiredSystemCertificationEntity, CPRequiredSystemEntity, RequiredSystemTypesEntity } from 'src/typeorm/models';
...
@Module({
  imports: [TypeOrmModule.forFeature([CPRequiredSystemEntity, RequiredSystemBusinessClassificationEntity, RequiredSystemCertificationEntity, RequiredSystemTypesEntity])],
